...
public class Pet {
    ...
    public void setIsAvailableForMatching(Boolean availableForMatching) {
        isAvailableForMatching = availableForMatching;
    }
    ...
    public List<PetMoodHistory> getMoods() {
        return moods;
    }


    public void setMoods(List<PetMoodHistory> moods) {
        this.moods = moods;
    }
